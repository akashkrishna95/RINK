...
import { RomiWidget, RomiWidgetProps, DEFAULT_PORTAL_URL } from '@ksum/romi-chat-core';

export type RomiRinkWidgetProps = Partial<RomiWidgetProps> & { apiUrl: string };

export default function RomiRinkWidget({ apiUrl, ...overrides }: RomiRinkWidgetProps) {
  return (
    <RomiWidget
      apiUrl={apiUrl}
      siteContext="rink-main"
      subtitle="RINK Guide"
      portalUrl={DEFAULT_PORTAL_URL}
      welcomeMessage={
        "Hi, I'm Romi — your guide to RINK, Kerala's Research Innovation Network.\n" +
        "Ask me what RINK is, how our programmes work, or where to find anything on this site."
      }
      starterChips={[
