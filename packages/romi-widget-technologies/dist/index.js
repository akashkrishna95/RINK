...
export default function RomiTechnologiesWidget({ apiUrl, ...overrides }) {
    return (_jsx(RomiWidget, { apiUrl: apiUrl, siteContext: "technologies", subtitle: "Technology Discovery", portalUrl: DEFAULT_PORTAL_URL, welcomeMessage: "Hi, I'm Romi. I can search 160+ licensable technologies from Kerala's research institutions.\n" +
            "Tell me your sector, problem, or budget — or tap a starter below.", starterChips: [
        ...
        technologyHref: (t) => `/technologies/${t.technology_id}`, ...overrides }));
}
