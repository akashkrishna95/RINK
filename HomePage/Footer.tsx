      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-8 pt-12 lg:pt-16 pb-8">
        <div className="grid grid-cols-12 gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="space-y-4">
              <p className="font-avenir text-slate-600 text-sm leading-relaxed max-w-sm" style={{ color: '#475569' }}>
                <span className="font-bold text-slate-800 block" style={{ color: '#1e293b' }}>G3B, Thejaswini, Technopark Campus</span>
                Kariyavattom, Trivandrum, Kerala 695581
              </p>

              <div className="space-y-2">
                <div className="font-helios text-sm font-bold text-slate-800 mb-1 select-none" style={{ color: '#1e293b' }}>
                  For more details
                </div>
                <a href="tel:08047180470" className="group flex items-center gap-2 font-avenir text-slate-600 hover:text-[#1b60bb] transition-colors text-sm lg:text-base w-fit gpu" style={{ color: '#475569' }}>
                ...
                <a href="tel:04712700270" className="group flex items-center gap-2 font-avenir text-slate-600 hover:text-[#1b60bb] transition-colors text-sm lg:text-base w-fit gpu" style={{ color: '#475569' }}>
                  <Phone className="w-4 h-4 shrink-0 text-slate-400 group-hover:text-[#1b60bb] transition-colors" />
                  <span className="relative">
                    0471-2700270
                    <span className="absolute bottom-0 left-0 w-full h-px bg-[#1b60bb] scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300" />
          ...
          >
            <h4 className="font-helios text-sm font-bold text-slate-800 uppercase tracking-wider mb-4" style={{ color: '#1e293b' }}>
              Navigate
            </h4>
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2.5 sm:gap-4 text-[11px] xs:text-xs sm:text-sm md:text-base whitespace-nowrap">
            <Link href="/privacy/privacy-policy" className="group font-avenir text-slate-600 hover:text-[#1b60bb] transition-colors inline-block w-fit gpu" style={{ color: '#475569' }}>
              <span className="relative">
                Privacy Policy
                <span className="absolute bottom-0 left-0 w-full h-px bg-[#1b60bb] scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300" />
              </span>
            ...
            <Link href="/privacy/terms" className="group font-avenir text-slate-600 hover:text-[#1b60bb] transition-colors inline-block w-fit gpu" style={{ color: '#475569' }}>
              <span className="relative">
                Terms & Conditions
                <span className="absolute bottom-0 left-0 w-full h-px bg-[#1b60bb] scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300" />
              </span>
            ...
            <span className="text-slate-300">•</span>
            <Link href="/privacy/cookies" className="group font-avenir text-slate-600 hover:text-[#1b60bb] transition-colors inline-block w-fit gpu" style={{ color: '#475569' }}>
              <span className="relative">
                Cookies
                <span className="absolute bottom-0 left-0 w-full h-px bg-[#1b60bb] scale-x-0 origin-left group-hover:scale-x-100 transition-transform duration-300" />
              </span>
