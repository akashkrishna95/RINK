...
//               className="bg-white font-helios font-bold text-[10px] md:text-[11px] px-3.5 py-1.5 rounded-t-xl rounded-bl-xl rounded-br-sm shadow-md mb-2 relative mr-3 select-none"
...
//             <img src="/images/romi-avatar.webp" alt="Romi AI Avatar" className="w-full h-full object-contain object-bottom drop-shadow-md" />
//           </div>
//           <span className="font-helios text-[18px] md:text-[20px] font-medium tracking-wide whitespace-nowrap ml-2">
