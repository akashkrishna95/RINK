    ...
    <div className="min-h-screen bg-[#F4F7FB] relative w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[400px] flex items-center justify-center overflow-hidden bg-slate-800 animate-pulse">
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16 w-full flex flex-col items-center">
          <div className="h-16 w-48 bg-slate-700 rounded-2xl mb-6"></div>
      ...
      {/* KSUM Funds Section Skeleton */}
      <section className="pt-12 pb-6 sm:pt-20 px-4 md:px-8 max-w-[1400px] mx-auto">
        <div className="h-12 w-64 bg-slate-200 rounded-2xl mb-8 animate-pulse"></div>
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center bg-white rounded-3xl p-4 sm:p-8 md:p-12 shadow-sm border border-slate-100 mt-2 animate-pulse">
          <div className="relative w-full h-[220px] sm:h-[300px] md:h-[400px] rounded-2xl bg-slate-200"></div>
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div className="h-12 w-48 bg-slate-200 rounded-xl mt-4"></div>
          </div>
        </div>
      </section>

      {/* External Funds Section Skeleton */}
      ...
      <div className="w-full pb-10">
            ...
            {[1, 2, 3, 4].map((i) => (
              ...
              >
                ...
                <div className="p-4 sm:p-5 flex flex-col flex-grow space-y-3">
                  ...
                  <div className="h-10 w-full bg-slate-100 rounded-2xl mt-auto"></div>
                </div>
              </div>
            ))}
          </div>
        ...
        <section className="py-4 px-4 md:px-8 max-w-[1400px] mx-auto mt-6">
          <div className="flex items-center gap-4 mb-8 sm:mb-10 animate-pulse">
            <div className="h-8 w-40 bg-slate-200 rounded-xl"></div>
            <div className="h-px bg-slate-200 flex-grow rounded-full"></div>
            <div className="h-8 w-16 bg-slate-200 rounded-full"></div>
