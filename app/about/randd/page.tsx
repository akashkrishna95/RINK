          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4 translate-y-8">
                <img src="https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&q=80" alt="Lab" className="w-full h-48 object-cover rounded-2xl shadow-lg" />
                <img src="https://images.unsplash.com/photo-1581092335397-9583eb92d232?auto=format&fit=crop&q=80" alt="Hardware" className="w-full h-64 object-cover rounded-2xl shadow-lg" />
              </div>
              <div className="space-y-4">
                <img src="https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&q=80" alt="Circuit" className="w-full h-64 object-cover rounded-2xl shadow-lg" />
                <div className="bg-[#1b60bb] p-6 rounded-2xl shadow-lg h-48 flex flex-col justify-center items-center text-center text-white">
                  <Rocket size={40} className="mb-3 text-[#5cc4fe]" />
                  <h3 className="font-helios font-bold text-xl">Scale Faster</h3>
                </div>
              </div>
            </div>
          </motion.div>
