...
export default function ResearchpreneurshipPage() {
  return (
    <main className="min-h-screen bg-[#F4F7FB] overflow-x-hidden">
      ...
      {/* Impact Metrics Wrapper (with parent bg-[#011a38] to show dark blue through the rounded bottom corners of the heading) */}
      <div className="bg-[#011a38]">
        {/* Impact Metrics Heading Area (Light background, rounded bottom) */}
        ...
        {/* Impact Metrics Cards Area (Dark Blue background) */}
